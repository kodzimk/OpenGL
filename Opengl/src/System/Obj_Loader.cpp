...
glm::vec3 Obj_Loader::read_vec3(std::vector<std::string> words,
...
glm::vec2 Obj_Loader::read_vec2(std::vector<std::string> words) {
    return glm::vec2(std::stof(words[1]), std::stof(words[2]));
}

void Obj_Loader::read_face(std::vector<std::string> words,
...
void Obj_Loader::read_corner(std::string description,
    std::vector<glm::vec3>& v, std::vector<glm::vec2>& vt,
    std::vector<glm::vec3>& vn, std::vector<float>& vertices) {
